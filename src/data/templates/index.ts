...
export const TEMPLATES: TemplateDefinition[] = [
  {
    ...
    folders: [
      ...
      { name: 'Creatures', defaultKind: 'creature', icon: 'paw-print' },
      { name: 'Factions', icon: 'shield' },
      { name: 'History', icon: 'scroll' },
      { name: 'Lore', icon: 'book' },
      { name: 'Objects', defaultKind: 'tech', icon: 'gem' },
  ...
  },
  {
    ...
    folders: [
      ...
      { name: 'Technology', defaultKind: 'tech', icon: 'cpu' },
      { name: 'Factions', icon: 'shield' },
      { name: 'History', icon: 'scroll' },
      { name: 'Lore', icon: 'book' },
      { name: 'Planets', defaultKind: 'location', icon: 'globe' },
      { name: 'Alien Life', defaultKind: 'creature', icon: 'paw-print' },
