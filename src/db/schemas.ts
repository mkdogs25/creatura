...
const hexColor = z.string().catch('#808080');
...
export const customThemeSchema = z.object({
  id: id,
  name: z.string().catch('Custom theme'),
...
export const settingsSchema = z.object({
  ...
  appearance: z
    .object({
      ...
      visualMode: z
        .enum(['natural', 'cyberpunk', 'pastel', 'monochrome', 'hueShift', 'custom'])
        .catch('natural'),
      customThemes: z.array(customThemeSchema).catch([]),
      activeCustomThemeId: z.string().nullable().catch(null),
